document.addEventListener('DOMContentLoaded', function () {
  ...
  if (animatableElements.length > 0 && 'IntersectionObserver' in window) {
    ...
    style.textContent = [
      ...
      '.testimonial-card, .team-card, .blog-card, .stat-item, .step-item {',
      '  opacity: 0;',
      ...
      '.blog-card.is-visible, .stat-item.is-visible, .step-item.is-visible {',
      '  opacity: 1;',
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "שניאור קורטס משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'e2469009-9569-4a12-8eb5-5fbd31193146',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'e2469009-9569-4a12-8eb5-5fbd31193146';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'e2469009-9569-4a12-8eb5-5fbd31193146';
